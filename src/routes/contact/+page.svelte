<!--
  ...
  ```
-->
<div class="isolate mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
	<div
	...
	<div class="mx-auto max-w-2xl text-center">
		...
		<p class="mt-2 text-lg/8 text-gray-600">We also have support resources available to help you</p>
	</div>
